        ...
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              <li><a href="dashboard-head.php">Dashboard Head</a></li>
              <li><a href="add_notice_head.php">Add Notice</a></li>
              <li class="active"><a href="view_notice_head.php">View Faculty Notice</a></li>
            </ul>
...
<?php
	...
	else
	{
			...
			<tr class='bg-success'>
			<th>Sr. No.</th><th>Notice name</th><th>Notice Content</th><th>Notice Date</th><th>Notice Valid From</th><th>Notice Valid Till</th><th>Action</th>
			</tr>";
			for($i=0;$i<$n;$i++)
			{
				$arr = mysql_fetch_assoc($query);
				...
				echo "<td><a href='delete_notice.php?id=$arr[notice_id]'>Delete</a>";
				echo "</tr>";
			}
			//print_r($arr);
			echo "</table>";
