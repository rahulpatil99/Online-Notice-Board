...
<html>
  ...
  <body>
    ...
    <div class="container">
      	<div class="row">
        	<h3 class="white">Keys:</h3>
            <form>
          		APP ID: <input type="text" class="app_id" value="65c5e877" disabled>
            	APP KEY: <input type="text" class="app_key" value="86896bae836fd173a12298486cd1694d" disabled>
...
<!--                    Image (public URL or base64 data): <input type="text" class="image" name="Image">-->
                    Image (local file): <input type="file" class="image-upload form-control" name="Image Upload">
                  	...
                  	Faculty ID: <input type="text" class="subject_id form-control" name="Subject ID">
                  	<div class="spacer" style="padding-top:40px"></div>
                  	<input type="button" id="testEnroll" value="Enroll Face" class="btn btn-success btn-lg form-control" />
              	</form>
            </div>
      	</div>
<!--
