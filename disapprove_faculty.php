...
<?php
	...
	$q = mysql_query("select * from	faculty where active=1 and email ='$_POST[email]'")or die(mysql_error());
	...
	else
	{
		...
		for($i=0;$i<$n;$i++)
		{
			...
			echo "<td> <a href='disapprove.php?id=$arr[faculty_id]'>Disapprove</a>";
	...
	$q = mysql_query("select * from	faculty where active=1")or die(mysql_error());
