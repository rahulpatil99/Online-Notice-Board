...
<body>
            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="disapprove_student.php">Student Disapproval</a></li>
                    </ul>
    ...
    function search()
    {
        ...
        $q = mysqli_query($con, "select * from	student where active=1 and email ='$_POST[email]'")or die(mysql_error());
        ...
        if ($n==0) {
            ...
            for ($i=0;$i<$n;$i++) {
                ...
                echo "<td> <a href='disapprove.php?user=student&&id=$arr[id]'><button class='btn btn-ml btn-warning'>Disapprove</button></a>";
...
function showAll()
{
    ...
    $con = mysqli_connect("localhost", "root", "", "notice_board")or die(mysql_error());
    // $con = mysqli_connect("sql302.epizy.com", "epiz_30447430", "xOonYq2cOHT", "epiz_30447430_notice_board")or die(mysql_error());
    $q = mysqli_query($con, "select * from	student where active=1")or die(mysql_error());
